    ...
    if (command_length > 0) {
        if (command_length == 1) {
            if (all_commands[0] == "ping") {
                ...
                Stream({ id: id, code: 204, command: command });
            ...
            if (all_commands[0] == "bcast") {
                ...
                if (all_commands[1] == "-v") {
                    ...
                    myport.write(command_sent);
                    Stream({ id: id, code: 203, command: command });
                } else {
            ...
            if (all_commands[0] == "stream") {
                if (all_commands[1] == "-a") {
                    if (all_commands[2] == "s") {
                        ...
                        myport.write(command_sent);
                        Stream({ id: id, code: 200, req: req, res: res, command: command });
                    } else {
                    ...
                    let command_sent = `${all_commands[0]} ${all_commands[1]} ${all_commands[2]} ${all_commands[3]} ${all_commands[4]}\n`
                    myport.write(command_sent)
                    Stream({ id: id, code: 201, tag: "Temperature", command: command })
                } else if (all_commands[1] == "-h") {
                    let command_sent = `${all_commands[0]} ${all_commands[1]} ${all_commands[2]} ${all_commands[3]} ${all_commands[4]}\n`
                    myport.write(command_sent)
                    Stream({ id: id, code: 201, tag: "Humudity", command: command })
                } else if (all_commands[1] == "-v") {
                    let command_sent = `${all_commands[0]} ${all_commands[1]} ${all_commands[2]} ${all_commands[3]} ${all_commands[4]}\n`
                    myport.write(command_sent)
                    Stream({ id: id, code: 201, tag: "Volatage", command: command })
                } else if (all_commands[1] == '-c') {
                    let command_sent = `${all_commands[0]} ${all_commands[1]} ${all_commands[2]} ${all_commands[3]} ${all_commands[4]}\n`
                    myport.write(command_sent)
                    Stream({ id: id, code: 201, tag: "Current", command: command })
                } else if (all_commands[1] == "-o") {
                    let command_sent = `${all_commands[0]} ${all_commands[1]} ${all_commands[2]} ${all_commands[3]} ${all_commands[4]}\n`
                    myport.write(command_sent)
                    Stream({ id: id, code: 201, tag: "Oil", command: command })
                } else {
